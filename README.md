...
* Each time a video is viewed requests alternate between CDN and P2P delivery.
* P2P served views reward a random subset of online seeders with MYNW for sharing the video.
